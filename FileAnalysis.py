from PyQt6.QtWidgets import (QWidget,QBoxLayout,QLabel,
...
#il faudra retirer ca 
import sys
sys.path.append("C:\\Users\\linda\\OneDrive\\Documents\\M1 SORBONNE\\S2\\STAGE\\Code_marovany_detection-master\\marovany_detection-master")
...
class FileAnalysis(QWidget):
   ...
   #------Midi-----#
    ...
    def store_new_params(self, new_params: dict):
        ...
        self.header.Params_Change(self)
