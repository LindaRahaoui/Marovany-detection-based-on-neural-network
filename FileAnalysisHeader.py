...
class FileAnalysisHeader(QWidget):
    ...
    def Params_Change(self,parent):
        # Supprime le widget du layout
        self.header_box.removeWidget(self.note_label)
        self.header_box.removeWidget(self.plot_time_series_btn)
        self.header_box.removeWidget(self.plot_note_tracking_btn)
        self.header_box.removeWidget(self.reset_plot_btn)
        self.header_box.removeWidget(self.params_btn)
        self.header_box.removeWidget(self.remove_btn)

        self.note_label = QLabel("Note : " + str(parent.params["note_name"]))
        self.note_label.adjustSize()
